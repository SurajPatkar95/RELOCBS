...
{
    public class BussinessLogicException : BaseException, ISerializable
    {
        ...
        public BussinessLogicException(string LoginID, string ClassName, string Module, string message, System.Exception inner)
           : base(message, inner)
        {
            CSubs.LogError(ClassName, Module, inner.ToString());
        }

        protected BussinessLogicException(SerializationInfo info, StreamingContext context)
           : base(info, context)
        {
            //Add implemenation
        }
